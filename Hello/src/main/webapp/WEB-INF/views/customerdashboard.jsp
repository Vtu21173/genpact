...
<head>
    ...
    <style>
        ...
        .tile {
            width: 45%; /* Adjusted width for 2 buttons in a row */
            margin-bottom: 20px;
            text-align: center;
            position: relative;
        ...
        button {
            ...
            background-color: grey; /* Dark blue button */
            color: white;
            ...
            text-decoration: none; /* Ensure button link style is consistent */
        }
...
%>
    ...
    <div class="tiles-container">
        <div class="tile">
            ...
            <button><a href="<%= request.getContextPath() %>/AccountServlet">Account Details</a></button>
        </div>
        <div class="tile">
        ...
        <div class="tile">
            ...
            <button><a href="<%= request.getContextPath() %>/DeleteServlet">Delete Account</a></button>
        </div>
    </div>
<%
    } else {
