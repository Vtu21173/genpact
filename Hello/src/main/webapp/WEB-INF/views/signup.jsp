...
<head>
    ...
    <style>
        ...
        input[type="submit"]:hover {
            background-color: #0a5a0a; /* Darker green color on hover */
            font-weight: bold;
        }
        .error-message {
            color: red;
...
<form method="post" action="<%= request.getContextPath() %>/RegisterServlet" onsubmit="return validateForm()" enctype="multipart/form-data">
    ...
    <input type="file" id="id_proof" name="id_proof" accept="image/png"><br>
    <div id="formError" class="error-message"></div>
    <input type="submit" value="Register">
    <p class="note"><strong>Note:</strong> ID proof should be in PNG format.</p>
</form>
<script>
    function validateForm() {
        ...
        if (accountType !== "savings" && accountType !== "current") {
            formError.innerHTML = "Account should be either Savings or Current";
            return false;
        }
